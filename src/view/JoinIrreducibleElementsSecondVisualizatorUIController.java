 ...
 * @author Ale
 */
public class JoinIrreducibleElementsSecondVisualizatorUIController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        joinIrreducibleElementsLabel.setText("(J(" + DownsetInputManagerUIController.getSetName() + "), ≤)");
